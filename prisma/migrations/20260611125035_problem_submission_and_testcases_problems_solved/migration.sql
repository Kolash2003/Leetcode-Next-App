...
-- AddForeignKey
ALTER TABLE "Submission" ADD CONSTRAINT "Submission_probelemId_fkey" FOREIGN KEY ("probelemId") REFERENCES "Problem"("id") ON DELETE CASCADE ON UPDATE CASCADE;
